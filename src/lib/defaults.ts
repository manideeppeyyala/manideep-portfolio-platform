...
export const DEFAULT_CONTENT: Content = {
  ...
  navigation: [
    ...
    { id: "nav_contact", label: "Contact", href: "#contact", external: false, order: 6, enabled: true },
  ],
  ...
  sections: [
    ...
    { key: "testimonials", label: "Testimonials", enabled: false, order: 7 },
    { key: "contact", label: "Contact", enabled: true, order: 8 },
    // Rendered inside the Experience timeline, not as its own band.
    { key: "education", label: "Education (in timeline)", enabled: false, order: 9 },
  ],
